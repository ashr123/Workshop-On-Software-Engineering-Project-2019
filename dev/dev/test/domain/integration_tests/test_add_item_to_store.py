...
from dev.main.domain import Member
...
def test_add_item_to_store():
	...
	assert facade.add_item_to_store(session_id=session_id, store_name=new_store_name, itemName=new_item_name,
	                                desc="cool item",
	                                price=12.5, amount=1)
	store = facade.get_store(session_id=session_id, store_name=new_store_name)
