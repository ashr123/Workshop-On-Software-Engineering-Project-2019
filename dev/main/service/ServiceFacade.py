...
class ServiceFacade(object):
    ...
    def make_collection_pass(self):
        return DomainFacade.make_collection_pass()

    def make_collection_fail(self):
        return DomainFacade.make_collection_fail()

    def make_consistency_pass(self):
        return DomainFacade.make_consistency_pass()

    def make_consistency_fail(self):
        return DomainFacade.make_consistency_fail()

    def make_supply_pass(self):
        return DomainFacade.make_supply_pass()
