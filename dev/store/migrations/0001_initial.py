# Generated by Django 2.2.1 on 2019-06-18 22:23
	...
	operations = [
		migrations.CreateModel(
			...
			fields=[
				...
				('category',
				 models.CharField(choices=[('1', 'ALL'), ('2', 'HOME'), ('3', 'WORK')], default=1, max_length=30)),
		...
		migrations.CreateModel(
			...
			options={
				'permissions': (('ADD_ITEM', 'add item'), ('REMOVE_ITEM', 'delete item'), ('EDIT_ITEM', 'update item'),
				                ('ADD_MANAGER', 'add manager'), ('REMOVE_STORE', 'delete store'),
				                ('ADD_DISCOUNT', 'add discount'), ('ADD_RULE', 'add rule')),
			},
		),
		migrations.CreateModel(
			...
			fields=[
				('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
				('managers_who_wait',
				 models.ManyToManyField(related_name='store_managers_to_wait', to='store.ManagersWhoWait')),
		...
		migrations.CreateModel(
			...
			fields=[
				...
				('type', models.CharField(
					choices=[('MXQ', 'max_quantity'), ('MNQ', 'min_quantity'), ('RGO', 'registered_only'),
					         ('FBC', 'forbidden_countries')], max_length=3)),
